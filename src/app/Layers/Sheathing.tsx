...
const minArmourClearance = isCompacted
  ? ArmouringWireDiam * 1.7
  : ArmouringWireDiam * 0.50;
  const finalArmourRadius = beddingLayerEnd + minArmourClearance + ArmouringWireDiam;
    ...
    armourPositions.forEach((wire) => {
      svg
        ...
        .attr("cx", wire.x)
        .attr("cy", wire.y)
        .attr("r", ArmouringWireDiam * 1.5)
        .attr("fill", ArmouringColour);
    });

    // ✅ Sheathing layer added outside the armouring wires
    const sheathingRadius = finalArmourRadius + ArmouringWireDiam + ArmouringWireDiam +2;
    ...
    svg.append("circle")
      ...
      .attr("stroke-width", SheathingThickness*3 )
